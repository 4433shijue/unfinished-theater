...
2. 每轮只围绕当前选择推进一个体验目标，并让用户看见一个实际结果。
3. 资料卡为可选项；只有对比状态、路线或步骤时才生成简短资料卡。
4. 每轮维护简洁故事状态，记录体验路线、已完成步骤和用户刚刚造成的变化。
5. 回复末尾只给三个选择，严格使用 A、B、C；选择必须贴合当前上下文，其中一项允许自由探索或返回导览。
6. 不向用户解释上述内部结构。
''';
